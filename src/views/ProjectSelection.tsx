...
const ProjectSelection:FunctionComponent<TSProps> = (props) => {
	...
	return (
		<Projects>
            ...
            <DualColumns>
                <Column>
                    <VDL tabIndex={1} onKeyDown={(e) => e.key == 'Enter' && changeProject('vdl')} onClick={() => changeProject('vdl')}>
                    ...
                    <NES tabIndex={1} onKeyDown={(e) => e.key == 'Enter' && changeProject('nes')} onClick={() => changeProject('nes')}>
                ...
                <Column>
                    <LabShell tabIndex={1} onKeyDown={(e) => e.key == 'Enter' && changeProject('labshell')} onClick={() => changeProject('labshell')}>
                        ...
                        <LSScreenshot src={'/assets/img/screenshot-labshell.jpg'} alt={'LabShell lab screenshot'} />
                    </LabShell>
                </Column>
            </DualColumns>
		</Projects>
