...
const Header:FunctionComponent<TSProps> = (props) => {
    ...
    const toggleTheLights = () => {
        props.setTheme({darkMode:!props.theme.darkMode});
    }
...
const HeaderContainer = styled.header((props) => ({
    ...
    alignItems:'center',
    background:props.scrollPosition > 50 ? props.theme.darkMode ? 'rgba(28,29,30,.9)':'rgba(246,248,250,.9)':'transparent',
